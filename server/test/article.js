...
describe('Article', () => {
    ...
    it('GET /articles - Articles not found ', (done) => {
        chai.request(app)
            .get('/articles')
            .end((err, res) => {
                console.log(err, res)
                ...
                res.body.should.have.property('message').eql('Articles not found');
                done();
            });
    });

    it('POST /articles -  it should create a new Article', (done) => {
        let user = { user_id }
        const article = {
            title: "Article 1",
